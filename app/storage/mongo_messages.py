...
class MongoMessageDatabase:
    ...
    def _situation(doc: Dict[str, Any]) -> Situation:
        return Situation(
            ...
            # Back-compat: situations written before the rename still carry guest_affected.
            critical_impact=bool(doc.get("critical_impact", doc.get("guest_affected", False))),
        ...
        await self.situations.insert_one(
            {
                ...
                "critical_impact": decision.critical_impact,
    ...
    async def update_situation(self, situation_id: int, msg: IncomingMessage, decision: SituationDecision, cls: PriorityClassification) -> None:
        ...
        update = {
            ...
            "critical_impact": bool(existing.get("critical_impact", existing.get("guest_affected", False))) or decision.critical_impact,
